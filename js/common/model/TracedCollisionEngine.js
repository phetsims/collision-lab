...
/**
 * TracedCollisionEngine is a CollisionEngine sub-type that handles recording the trailing 'Paths' of the Balls
...
import TracedBallSystem from './TracedBallSystem.js';

class TracedCollisionEngine extends CollisionEngine {

  /**
   * @param {PlayArea} playArea
   * @param {TracedBallSystem} ballSystem
   * @param {Property.<number>} elapsedTimeProperty
   */
  constructor( playArea, ballSystem, elapsedTimeProperty ) {
    assert && assert( playArea instanceof PlayArea, `invalid playArea: ${playArea}` );
    assert && assert( ballSystem instanceof TracedBallSystem, `invalid ballSystem: ${ballSystem}` );
...
collisionLab.register( 'TracedCollisionEngine', TracedCollisionEngine );
export default TracedCollisionEngine;